...
LEVELS: list[LevelConfig] = [
    LevelConfig(
        ...
        description="Depure o SIGA e biblioteca digital.",
        words=[
    ...
    LevelConfig(
        ...
        description="Conserte circuitos e codigo.",
        words=[
    ...
    LevelConfig(
        ...
        description="Remova muros digitais e garanta acesso.",
        words=[
    ...
    LevelConfig(
        ...
        description="Conter a Anomalia e restaurar a rede.",
        words=[
            "SHUTDOWN","DELETE","CORRUPT","FUTURO","ENERGIA","LIMPA"
        ],
        spawn_factor=1.0,
        speed_factor=1.0,
        target_score=0,  # Boss decide
        bg_color=(20,14,18),
        grid_color=(40,24,34),
        has_boss=True,
